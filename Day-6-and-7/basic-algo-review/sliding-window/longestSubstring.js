...
//*  Create a function called “longestSubstring” that accepts a string and return the length of the longest substring that contains all unique characters. The function should use a sliding window to keep track of the longest substring.
...
function longestSubstring(str){
    ...
    for () {
        ...
        // TODO: for each iteration either keep the current value of longest the same, otherwise replace the value of the variable keeping track of the longest substring with the new longest substring in our window (Hint: keep in mind that as the window changes, we need to be careful about how we calculate the length of the current substring)
